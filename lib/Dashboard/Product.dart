...
List<Product> product1 = [
  ...
  Product(
    ...
    price: 10000,
    description:
        "Buy and sell StockX Verified New Balance 550 White Green shoes BB550WT1 and thousands of other New Balance sneakers with price data and release dates.",
  ...
  Product(
    ...
    price: 14000,
    description:
        "Non leather, cruelty free and Leather free shoes, boots and trainers .",
  ...
  Product(
    ...
    price: 12000,
    description:
        "Air Jordan is a line of basketball shoes and athletic apparel produced by American corporation Nike",
...
List<Product> product2 = [
  Product(
    ...
    price: 14000,
    description:
        "Add a classic sneaker style to your rotation with green Converse shoes",
