...
class Product{
  ...
  List<Product> product1=[
    ...
    Product(
      ...
      color: Color.fromARGB(250, 150, 220, 170),
),
    Product(
      id:4,
      title:"Black",
      price:10000,
      description:"No leather used , cruelty free and lLeather free shoes, boots and trainers .",
      image:"assets/images/vegan_black.png",
      color: Color.fromARGB(250, 190, 160, 150),
),
    Product(
      id:5,
      title:"Nike",
