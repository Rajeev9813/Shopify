...
class Onboarding extends StatelessWidget {
  ...
  final List<PageViewModel> pages = [
    ...
    PageViewModel(
        title: "Purchase",
        body: "Step into Style, Discover Your Perfect Pair",
        footer: ElevatedButton(
          onPressed: () {},
          child: const Text("Explore"),
        ),
        image: Center(
          child: Image.asset("assets/images/Dunk.png"),
          heightFactor: 200,
          widthFactor: 100,
        ),
        decoration: const PageDecoration(
    ...
    PageViewModel(
        ...
        body:
            "Take Flight.Shop the latest Air Jordan Sneakers, including the Air Jordan 1 Retro High OG 'Chicago Lost & Found' and more at Shopify",
        footer: ElevatedButton(
          onPressed: () {},
